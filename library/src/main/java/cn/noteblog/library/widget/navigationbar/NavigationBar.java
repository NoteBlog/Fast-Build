...
import cn.noteblog.library.util.UtilScreen;

/**
 * Author: Design(18330080926@163.com)
 * Date: 2016/4/14
 * Time: 10:55
...
//    private int mBackgroundStyle = BACKGROUND_STYLE_DEFAULT;
    ...
    private void init() {
        ...
        setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) getContext().getResources().getDimension(R.dimen.bottom_navigation_56)));
        ...
        ViewCompat.setElevation(this, getContext().getResources().getDimension(R.dimen.bottom_navigation_8));
...
//            }
    ...
    public static class BottomNavigationHelper {
        ...
        public static int[] getClassicMeasurements(Context context, int screenWidth, int noOfTabs, boolean scrollable) {
            ...
            int minWidth = (int) context.getResources().getDimension(R.dimen.bottom_navigation_104);
            int maxWidth = (int) context.getResources().getDimension(R.dimen.bottom_navigation_120);
            int itemWidth = screenWidth / noOfTabs;
            if (itemWidth < minWidth && scrollable) {
                itemWidth = (int) context.getResources().getDimension(R.dimen.bottom_navigation_120);
        ...
        public static int[] getShiftingMeasurements(Context context, int screenWidth, int noOfTabs, boolean scrollable) {
            int result[] = new int[2];
            int minWidth = (int) context.getResources().getDimension(R.dimen.bottom_navigation_64);
            int maxWidth = (int) context.getResources().getDimension(R.dimen.bottom_navigation_96);
