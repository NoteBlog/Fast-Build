...
public class LayoutRelative extends RelativeLayout implements Expandable {
    ...
    public LayoutRelative(final Context context) {
        this(context, null);
    }

    public LayoutRelative(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LayoutRelative(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public LayoutRelative(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    ...
    private void init(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        ...
        orientation = a.getInteger(R.styleable.Expandable_exp_orientation, VERTICAL);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            childSizeList.add(isVertical() ? view.getMeasuredHeight() + params.topMargin + params.bottomMargin : view.getMeasuredWidth() + params.leftMargin + params.rightMargin);
        }
