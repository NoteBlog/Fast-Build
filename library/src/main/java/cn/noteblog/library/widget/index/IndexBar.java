package cn.noteblog.library.widget.index;
...
public class IndexBar extends View {
    ...
    public IndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setPadding(0, UtilDensity.dp2px(context, 20), 0, UtilDensity.dp2px(context, 20));
    }

    @Override
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        super.onSizeChanged(w, h, oldw, oldh);
        mHalfWidth = w - UtilDensity.dp2px(getContext(), 16);
        ...
        mIsDownRect.set(w - UtilDensity.dp2px(getContext(), (16 * 2)), 0, w, h);
    }
