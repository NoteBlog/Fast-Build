...
import cn.noteblog.library.widget.banner.transformer.BaseTransformer;
import cn.noteblog.library.widget.banner.transformer.TransitionType;
...
public class Banner extends RelativeLayout implements BannerViewPager.AutoPlayDelegate, ViewPager.OnPageChangeListener {
    ...
    private TransitionType mTransitionEffect;
    ...
    private void initDefaultAttrs(Context context) {
        ...
        mTransitionEffect = TransitionType.Default;
    }
    ...
    private void initCustomAttr(int attr, TypedArray typedArray) {
        if (attr == R.styleable.Banner_banner_pointDrawable) {
            ...
            int ordinal = typedArray.getInt(attr, TransitionType.Accordion.ordinal());
            mTransitionEffect = TransitionType.values()[ordinal];
    ...
    private void initView(Context context) {
        ...
        if (mPlaceholderDrawableResId != NO_PLACEHOLDER_DRAWABLE) {
            mPlaceholderIv = BannerUtil.getItemImageView(context, mPlaceholderDrawableResId);
    ...
    public void setData(List<? extends Object> models, List<String> tips) {
        setData(R.layout.banner_item, models, tips);
    }
    ...
    private void initViewPager() {
        ...
        mViewPager.setAllowUserScrollable(mAllowUserScrollable);
        mViewPager.setPageTransformer(true, BaseTransformer.getPageTransformer(mTransitionEffect));
    ...
    // 设置页面切换换动画
    public void setTransitionEffect(TransitionType effect) {
    ...
    public interface Adapter {
        void fillBannerItem(Banner banner, View view, Object model, int position);
    }

    public interface OnItemClickListener {
        void onBannerItemClick(Banner banner, View view, Object model, int position);
    }
            ...
            if (mOnItemClickListener != null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mOnItemClickListener.onBannerItemClick(Banner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
                    }
                });
            }

            if (mAdapter != null) {
                mAdapter.fillBannerItem(Banner.this, view, mModels == null ? null : mModels.get(finalPosition), finalPosition);
            }
