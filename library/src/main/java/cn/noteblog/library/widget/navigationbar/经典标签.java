...
class 经典标签 extends Tab {
    ...
    @Override
    protected void init() {
        paddingTopActive = (int) getResources().getDimension(R.dimen.bottom_navigation_6);
        paddingTopInActive = (int) getResources().getDimension(R.dimen.bottom_navigation_8);
        ...
        labelScale = getResources().getDimension(R.dimen.bottom_navigation_14) / getResources().getDimension(R.dimen.bottom_navigation_12);
